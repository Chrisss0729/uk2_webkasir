        ...
        <div class="card border-0">
            ...
            <div class="card-header-custom">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="fw-bold text-primary mb-0">👥 Detail Data User</h4>
                ...
                <div class="form-container">
                    ...
                    <form>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" value="<?= ucfirst($user->hak_akses) ?>" disabled>
                        </div>
                        <div class="mb-4">
                            <label for="tanggal_gabung" class="form-label">Tanggal Gabung</label>
                            <input type="text" class="form-control" value="<?= date('d F Y H:i', strtotime($user->tanggal_gabung)) ?>" disabled>
                        </div>
                    </form>
                </div>
            </div>
