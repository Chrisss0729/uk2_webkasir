        ...
        <div class="card border-0">
            ...
            <div class="card-header-custom">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="fw-bold text-primary mb-0">📦 Tambah Produk</h4>
            ...
            <div class="card-body">
                <div class="form-container">
                    ...
                    <form action="../../action/produk/store.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-4">
                            <label for="kode_produk" class="form-label">Kode Produk</label>
                            <input type="text" name="kode_produk" class="form-control" id="kode_produk"
                                placeholder="Masukan Kode Produk.." required
                                value="<?php echo isset($_POST['kode_produk']) ? htmlspecialchars($_POST['kode_produk']) : ''; ?>">
                            <div class="form-text">Masukan kode unik untuk produk</div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">Pilih kategori untuk produk</div>
                        </div>

                        <div class="mb-4">
                            <label for="harga" class="form-label">Harga</label>
                            <input type="text" name="harga" class="form-control" id="harga"
                                placeholder="Masukan Harga.." min="0" step="0.01" required
                                value="<?php echo isset($_POST['harga']) ? htmlspecialchars($_POST['harga']) : ''; ?>">
                            <div class="form-text">Masukan harga dalam format angka</div>
                        </div>

                        <div class="mb-4">
                            <label for="stok" class="form-label">Stok</label>
                            <input type="number" name="stok" class="form-control" id="stok"
                                placeholder="Masukan Stok.." min="0" required
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">Upload foto produk (format: JPG, PNG, JPEG)</div>
                            <img id="imagePreview" class="image-preview" src="#" alt="Preview">
                        </div>

                        <button type="submit" class="btn btn-success" name="tombol">✚ Tambah Produk</button>
                    </form>
                </div>
            </div>
        </div>
